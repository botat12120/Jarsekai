...
_0x428f93.connect("mongodb+srv://Arena:zMsR5hmHqZpRg3v7@cluster0.k8ontyi.mongodb.net/?retryWrites=true&w=majority", {
...
handler.command = ["الالقاب", "تسجيل", "لقبي", "لقبه", "حذف", "متوفر"];
handler.tags = ["BK9"];
