...
let venomImg = 'https://telegra.ph/file/695344a849ce44983c8b1.png';
...
let venomText = `
*⌗ - يووو ارحب ذي قائمة اوامر المضادات، تفضل اختر من الزر اسفله :*
`
        ...
        buttons: [
            ...
            name: 'single_select',
              buttonParamsJson: JSON.stringify({
                title: 'الــمـــضــادات',
                sections: [
                {
                    title: '⌗ - الــتــرحــيــب :',
                    highlight_label: '',
                    rows: [
                      {
                  ...
                  {
                    title: '⌗ - مـضـاد الـرسـائـل الـسـريـة :',
                    highlight_label: '',
                    rows: [
                      {
                      header: 'تــفــعــيــل',
            ...
            {
              name: 'quick_reply',
              buttonParamsJson: '{"display_text":"اشــتـــراك","id":".اشتراك"}' 
             }, 
              {
               name: "cta_url",
