...
let venomImg = 'https://telegra.ph/file/317ecd660e6e5c58aa72a.png';
...
- *#الالقاب*
> يرسل لك البوت قائمة الالقاب في هذه المجموعة
- *#لقبي*
> يعطيك البوت لقبك
- *#لقبه*
...
`
    ...
    header: {
        title: `*⌗ - يووو ارحب ذي قائمة اوامر الالقاب، تفضل :*`,
    ...
    nativeFlowMessage: {
        buttons: [
            {
              name: 'quick_reply',
              buttonParamsJson: '{"display_text":"اشـــتـــراك","id":".اشتراك"}' 
             }, 
              {
               name: "cta_url",
